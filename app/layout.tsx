  ...
  return (
    <html lang="fr" suppressHydrationWarning>
      ...
      <body className="pb-20 md:pb-0 md:pl-64" suppressHydrationWarning>
        ...
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[100] focus:px-4 focus:py-2 focus:bg-primary focus:text-white focus:ring-4 focus:ring-slate-500 focus:rounded-lg"
        >
